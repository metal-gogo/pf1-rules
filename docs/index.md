...
- [Getting started](getting-started.md) — install the toolchain, build the local database, and run the CLI or web browser.
...
- [Entity taxonomy](entity-taxonomy.md) — define canonical IDs, structural parents, classifications, aliases, and migration invariants.
- [Ingestion](ingestion.md) — capture sources, process level-scoped queues, validate records, and review ingestion design notes.
- [Feat ingestion plan](feat-ingestion-plan.md) — review taxonomy decisions, the ten-feat pilot, implementation phases, and completion gates.
- [Rich-text spell descriptions](rich-text.md) — understand inline relationship rules and roll rich text out to more spells.
- [Rich-text rollout status](rich-text-rollout.md) — track converted batches, corpus audit counts, and open issues.
