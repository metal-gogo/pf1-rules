/*
  ...
  - You are about to alter the column `basis` on the `spell_inheritance` table. The data in that column could be lost. The data in that column will be cast from `String` to `Json`.
